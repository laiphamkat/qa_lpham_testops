...
testObj = findTestObject('Object Repository/Page_team_project_grid/hyperlink_team_project_grid_plan_job_1')
...
testObj = findTestObject('Object Repository/Page_team_project_grid_plan_job/hyperlink_object_2')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/grid/plan/.*/job(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 8: At Page_executions click on hyperlink_requirements --> navigate to Page_test-reports_test-design_requirement-test-run-coverage'

testObj = findTestObject('Object Repository/Page_team_project_executions/hyperlink_requirements')
...
'step 9: At Page_test-reports_test-design_requirement-test-run-coverage click on hyperlink_test_cases --> navigate to Page_test-reports_test-maintenance_active'
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/test-reports/test-design/requirement-test-run-coverage(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 10: Add visual checkpoint at Page_test-reports_test-maintenance_active'
