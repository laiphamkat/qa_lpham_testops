...
'step 5: At Page_test-project click on hyperlink_test_environments --> navigate to Page_agent'
...
'step 6: At Page_agent click on hyperlink_executions --> navigate to Page_test-planning'

testObj = findTestObject('Object Repository/Page_team_project_agent/hyperlink_executions')
...
'step 7: At Page_test-planning click on hyperlink_test_run_list --> navigate to Page_grid'
...
'step 8: At Page_grid click on hyperlink_team_project_grid_plan_job --> navigate to Page_job'
...
'step 9: Add visual checkpoint at Page_job'
