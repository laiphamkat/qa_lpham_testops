...
testObj = findTestObject('Object Repository/Page_team_project_releases/hyperlink_create_release')
...
'step 6: At Page_releases_create click on hyperlink_requirements --> navigate to Page_requirements'

testObj = findTestObject('Object Repository/Page_team_project_releases_create/hyperlink_requirements')
...
WS.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/releases/create(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 7: Add visual checkpoint at Page_requirements'
