...
'step 6: At Page_test-environment-installation click on hyperlink_object'
...
'step 7: At Page_test-environment-installation click on hyperlink_team_project_agent --> navigate to Page_agent'

testObj = findTestObject('Object Repository/Page_team_project_test-environment-installation/hyperlink_team_project_agent')
...
'step 8: At Page_agent click on hyperlink_team_project_agent_test_cloud --> navigate to Page_agent_test-cloud'
...
'step 9: At Page_agent_test-cloud click on hyperlink_integrations --> navigate to Page_integrations'

testObj = findTestObject('Object Repository/Page_team_project_agent_test-cloud/hyperlink_integrations')
...
WS.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/agent/test-cloud(?:#.*)?(?:\\?.*)?$', true)
