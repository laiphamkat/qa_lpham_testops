...
'step 6: At Page_katalon-eyes click on hyperlink_visual_baseline_collections --> navigate to Page_baseline-collection'
...
'step 7: At Page_baseline-collection click on hyperlink_team_project_baseline_collection'

testObj = findTestObject('Object Repository/Page_team_project_baseline-collection/hyperlink_object_2')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/baseline-collection(?:#.*)?(?:\\?.*)?$', true)
