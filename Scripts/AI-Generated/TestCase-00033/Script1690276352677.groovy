...
testObj = findTestObject('Object Repository/Page_team_project_agent_test-cloud/hyperlink_object_30')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/agent/test-cloud(?:#.*)?(?:\\?.*)?$', true)
