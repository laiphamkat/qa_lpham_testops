...
'step 4: At Page_executions click on hyperlink_test_runs --> navigate to Page_overview'

testObj = findTestObject('Object Repository/Page_team_project_executions/hyperlink_test_runs')
...
'step 5: At Page_overview click on hyperlink_configurations --> navigate to Page_test-project'

testObj = findTestObject('Object Repository/Page_team_project_overview/hyperlink_configurations')
...
'step 6: At Page_test-project click on hyperlink_custom_fields --> navigate to Page_custom-fields'

testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_custom_fields')
...
'step 7: Add visual checkpoint at Page_custom-fields'
