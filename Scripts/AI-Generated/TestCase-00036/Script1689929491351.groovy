...
'step 6: At Page_import-manual-reports click on hyperlink_test_cases --> navigate to Page_test-reports_test-maintenance_active'

testObj = findTestObject('Object Repository/Page_team_project_import-manual-reports/hyperlink_object_12')
...
WS.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/import-manual-reports(?:#.*)?(?:\\?.*)?$', true)
