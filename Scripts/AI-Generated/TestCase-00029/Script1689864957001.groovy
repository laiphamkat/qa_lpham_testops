...
'step 5: At Page_test-project click on hyperlink_custom_fields --> navigate to Page_custom-fields'
...
'step 6: At Page_custom-fields click on hyperlink_testcloud_tunnels --> navigate to Page_testCloudTunnel'

testObj = findTestObject('Object Repository/Page_team_project_custom-fields/hyperlink_testcloud_tunnels')
...
WS.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/custom-fields(?:#.*)?(?:\\?.*)?$', true)
