...
'step 5: At Page_test-project click on hyperlink_configurations'

testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_configurations')
...
'step 6: At Page_test-project click on th_object'

testObj = findTestObject('Object Repository/Page_team_project_test-project/th_object')
...
testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_integrations')
...
'step 8: At Page_integrations click on hyperlink_testcloud_tunnels --> navigate to Page_testCloudTunnel'
...
'step 9: At Page_testCloudTunnel click on hyperlink_custom_fields --> navigate to Page_custom-fields'
