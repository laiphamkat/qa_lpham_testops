...
'step 6: At Page_agent click on hyperlink_testcloud_tunnels --> navigate to Page_testCloudTunnel'

testObj = findTestObject('Object Repository/Page_team_project_agent/hyperlink_testcloud_tunnels')
...
'step 7: At Page_testCloudTunnel click on hyperlink_integrations --> navigate to Page_integrations'

testObj = findTestObject('Object Repository/Page_team_project_testCloudTunnel/hyperlink_integrations')
