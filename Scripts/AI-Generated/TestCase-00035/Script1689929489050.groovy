...
'step 6: At Page_test-reports_test-design_requirement-test-run-coverage click on hyperlink_defects --> navigate to Page_defects'

testObj = findTestObject('Object Repository/Page_team_project_test-reports_test-design_requirement-test-run-/hyperlink_object')
