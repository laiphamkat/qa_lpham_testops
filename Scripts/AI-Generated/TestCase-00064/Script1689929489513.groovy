...
testObj = findTestObject('Object Repository/Page_team_project_git-test-project_setup/div_object_6')
...
'step 8: At Page_git-test-project_setup click on h5_object'

testObj = findTestObject('Object Repository/Page_team_project_git-test-project_setup/h5_object_3')
...
'step 10: At Page_test-project click on hyperlink_test_environments --> navigate to Page_agent'
...
'step 11: At Page_agent click on hyperlink_team_project_agent_k8s --> navigate to Page_agent_k8s'
...
'step 12: Add visual checkpoint at Page_agent_k8s'
