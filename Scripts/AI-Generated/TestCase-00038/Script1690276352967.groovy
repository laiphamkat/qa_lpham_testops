...
'step 5: At Page_test-design_test-cases click on hyperlink_test_suites --> navigate to Page_test-design_test-suites'
...
'step 6: At Page_test-design_test-suites click on hyperlink_test_objects --> navigate to Page_test-design_test-objects'
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/test-design/test-suites(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 7: At Page_test-design_test-objects click on hyperlink_web_services --> navigate to Page_web-services'

testObj = findTestObject('Object Repository/Page_team_project_test-design_test-objects/hyperlink_web_services')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/test-design/test-objects(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 8: At Page_web-services click on hyperlink_team_project_web_services_anomalies --> navigate to Page_web-services-anomalies'
...
'step 9: Add visual checkpoint at Page_web-services-anomalies'
